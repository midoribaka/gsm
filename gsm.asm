...
;*** Assembler directives**************************************************************
            LIST      p=16F628a     ; ђƄƌƎʅ Չс Ή̒ЋЎՒЌͅӁ.
#include   <p16F628A.inc>
            __CONFIG  03F21H       ; ㊔٠̏φʇ֒ʉ: ہމՁ ؙ̌^Ǝl WDT ؙ̌,
                                   ; ԔŁӔϙʠXT - ȅυӁՏҬ PWRTE ؋̀߅ή
...
reset       GOTO init    ; Go to initialization
            ORG  0x009 
;*** Initializations ********************************************************************
init        bsf        STATUS,RP0  	; "嘏ˎ" "ܔρѢ  ̏΁τ`֓ՁϏ؋ɠ
            bcf        STATUS,RP1  	; 1-ȏ Áϋn
            clrf       VRCON^80H        ; Ջ̀߅ωŠʓՏߎʋ`АВϏȏ ρђҖƎʑ.

            MOVLW     b'11000101'        ; ђƒڗʅ я хӅŎƍՠǒЎՕ
